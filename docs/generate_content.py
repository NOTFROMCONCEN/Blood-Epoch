...
ITEMS = [
    ...
    {'part': 2, 'id': 'p2-ch1-04', 'title': '回收队',         'section': '第一章·幸存者', 'type': 'story', 'chapter': '第一章', 'file': 'Part2/第一章/04-回收队.md'},
...
SECTIONS_ORDER_P2 = ['序章', '第一章·幸存者', '第二章·暗网', '第三章·圣女', '第四章·真相', '第五章·反击', '番外·续']
